import { Search, Cpu, Code, CheckCircle, ArrowRight, ArrowDown, Layout, Server, Database, Shield, Zap, BrainCircuit, Workflow, FilePlus, GitBranch, TerminalSquare, PackageOpen, Loader2, FileCode, Folder, Monitor } from 'lucide-react';
  ...
  return (
    <SectionWrapper
      ...
      heading={{
        ...
        subtitle: "A simple three-step process that transforms weeks of setup into minutes of productivity."
      }}
    >
      {/* Process steps */}
      <ProcessSteps 
                ...
                {activeStep === 0 && (
                  <div className="space-y-4">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-white font-medium">Describe Your Project</h3>
                    </div>
                    
                    <div className="p-4 bg-gray-900 rounded-lg border border-gray-800">
                      <p className="text-gray-300 text-sm">
                        {typedText}
                        {isTyping && <span className="inline-block w-2 h-4 bg-blue-400 ml-1 animate-blink"></span>}
                      </p>
                    </div>
                    
                    <div className="pt-2">
                      <div className="text-xs text-gray-500">Suggested Requirements:</div>
                      <div className="flex flex-wrap gap-2 mt-2">
                        {["Authentication", "Database", "API Integration", "Responsive UI", "Performance"].map((tag, i) => (
                ...
                {activeStep === 1 && (
                  <div className="space-y-4">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-white font-medium">Recommended Technology Stack</h3>
                    </div>
                    
                    <div className="p-4 bg-gray-900 rounded-lg border border-gray-800 mb-4">
                      <p className="text-gray-300 text-sm mb-2">
                        {typedText}
                        {isTyping && <span className="inline-block w-2 h-4 bg-purple-400 ml-1 animate-blink"></span>}
                      </p>
                    </div>
                    
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        { name: "Next.js", icon: Layout, score: 98, reason: "Best for SEO and performance" },
                        { name: "TypeScript", icon: Code, score: 95, reason: "Type safety for complex e-commerce" },
                        { name: "Stripe", icon: Server, score: 97, reason: "Secure payment processing" },
                        { name: "PostgreSQL", icon: Database, score: 92, reason: "Relational data for products" },
                        { name: "NextAuth.js", icon: Shield, score: 94, reason: "Authentication with social login" },
                        { name: "TailwindCSS", icon: Layout, score: 96, reason: "Rapid UI development" }
                      ].map((tech, i) => {
                        const TechIcon = tech.icon;
                        return (
                          <div key={i} className="flex items-start p-3 bg-gray-900/50 rounded-lg border border-gray-800">
                            ...
                            <div>
                              ...
                              <p className="text-gray-400 text-xs mt-1">{tech.reason}</p>
                            </div>
                          </div>
                        );
                      })}
                ...
                {activeStep === 2 && (
                  <div className="space-y-4">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-white font-medium">Generating Project Foundation</h3>
                    </div>
                    ...
                    <div className="bg-gray-900 rounded-lg border border-gray-800 overflow-hidden">
                      <div className="bg-gray-950 px-3 py-2 border-b border-gray-800">
                        <div className="flex items-center">
                          <TerminalSquare size={14} className="text-gray-400 mr-2" />
                          <span className="text-gray-400 text-xs">Terminal</span>
                        </div>
                      </div>
                      <div className="p-3 font-mono text-xs">
                        <div className="text-green-400">$ generating project structure...</div>
                        {isTyping ? (
                          ...
                          <>
                            <div className="text-gray-400 mt-1">
                              <span className="text-blue-400">→</span> Setup Next.js with TypeScript... <span className="text-green-400">✓</span>
                            </div>
                            <div className="text-gray-400 mt-1">
                              <span className="text-blue-400">→</span> Configure TailwindCSS... <span className="text-green-400">✓</span>
                            </div>
                            <div className="text-gray-400 mt-1">
                              <span className="text-blue-400">→</span> Add NextAuth.js authentication... <span className="text-green-400">✓</span>
                            </div>
                            <div className="text-gray-400 mt-1">
                              <span className="text-blue-400">→</span> Setup Stripe payment integration... <span className="text-green-400">✓</span>
                            </div>
                            <div className="text-gray-400 mt-1">
                              <span className="text-blue-400">→</span> Configure PostgreSQL with Prisma... <span className="text-green-400">✓</span>
                            </div>
                            <div className="text-gray-400 mt-1">
                              <span className="text-blue-400">→</span> Generate product models... <span className="text-green-400">✓</span>
                            </div>
                            <div className="text-gray-400 mt-1">
                              <span className="text-blue-400">→</span> Add cart functionality... <span className="text-green-400">✓</span>
                            </div>
                            <div className="text-green-400 mt-2">
                              ✨ Done in 15.4s
                            </div>
                            <div className="text-gray-500 mt-2">
                              Ready to use! Your project has been generated and is ready for development.
                            </div>
                          </>
                        )}
                      </div>
              ...
              <div className="mt-6 flex justify-end">
                <button
                  className={`px-4 py-2 rounded-lg text-white text-sm font-medium transition-all flex items-center ${
                    isTyping ? "bg-gray-700 cursor-not-allowed" : 
                    activeStep === 2 ? "bg-green-600 hover:bg-green-700" : "bg-blue-600 hover:bg-blue-700"
                  }`}
                  onClick={() => !isTyping && setActiveStep((prev) => (prev < 2 ? prev + 1 : 0))}
                  disabled={isTyping}
                >
...
const OutputPreview = ({ activeStep, isVisible }: { activeStep: number; isVisible?: boolean }) => {
  return (
    <div 
            ...
            <div className="bg-gray-950 border border-gray-800 rounded-lg overflow-hidden mb-4">
              <div className="bg-gray-900 px-4 py-2 border-b border-gray-800">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-300 text-sm">Project Structure</span>
                </div>
              </div>
            ...
            <div className="bg-gray-950 border border-gray-800 rounded-lg overflow-hidden">
              <div className="bg-gray-900 px-4 py-2 border-b border-gray-800">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-300 text-sm">CI/CD Configuration</span>
                </div>
              </div>
              <div className="p-4 font-mono text-xs text-gray-400">
                <div className="space-y-1">
            ...
            <div className="bg-gray-950 border border-gray-800 rounded-lg overflow-hidden mb-4">
              ...
              <div className="p-4 h-[220px] bg-gradient-to-br from-gray-900 to-gray-950 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <div className="text-white text-sm font-medium mb-1">Ready-to-use UI Components</div>
                  <div className="text-gray-400 text-xs max-w-xs mx-auto">Complete with authentication flows, product listings, cart functionality and checkout process</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-950 border border-gray-800 rounded-lg overflow-hidden">
              ...
              <div className="p-4 font-mono text-xs">
                <div className="space-y-2 text-gray-400">
                  <div className="text-green-400">// Authentication API routes</div>
                  <div>import NextAuth from "next-auth/next";</div>
                  <div>import {'{'} authOptions {'}'} from "@/lib/auth";</div>
                  <div className="text-purple-400">export default NextAuth(authOptions);</div>
                  
                  <div className="mt-3 text-green-400">// Product API endpoints</div>
                  <div>import {'{'} db {'}'} from "@/lib/db";</div>
                  <div className="text-blue-400">export async function GET() {'{'}</div>
                  <div className="ml-4">const products = await db.product.findMany();</div>
                  <div className="ml-4">return Response.json({'{'} products {'}'});</div>
                  <div>{'}'}</div>
                </div>
              </div>
            </div>
  ...
  const features = [
    {
      ...
      description: "Every project follows industry best practices for architecture, security, and performance.",
      icon: CheckCircle,
      color: "text-green-400",
      bgColor: "bg-green-900/20"
    },
    {
      ...
      description: "Comprehensive documentation generated automatically for your specific project setup.",
      icon: FileCode,
      color: "text-blue-400",
      bgColor: "bg-blue-900/20"
    },
    {
      title: "Testing Ready",
      description: "Testing frameworks configured with example tests to ensure quality from day one.",
      icon: Shield,
      color: "text-purple-400",
      bgColor: "bg-purple-900/20"
    },
    {
      ...
      description: "CI/CD pipelines, containerization, and deployment configurations included.",
      icon: Workflow,
