...
export default function FrameworksPage() {
  ...
  const { frameworks, setFrameworks, favoriteFrameworks, addFavorite, removeFavorite } = useFrameworkStore();
  ...
  const frameworkTypes = Array.from(new Set(frameworks.map(framework => framework.type)));
      ...
      <div className="space-y-6">
        ...
        <div className="alert bg-base-200">
          ...
          <div>
            ...
            <div className="text-xs">Choose a framework as the foundation for your project.</div>
          </div>
        </div>
            ...
            {filteredFrameworks.map(framework => (
              ...
              >
                ...
                <div className="card-body">
                  ...
                  <p className="text-sm line-clamp-2">{framework.description}</p>
                  ...
                  <div className="card-actions justify-between items-center mt-2">
                    <div className={cn(
                      "badge",
                      framework.type === "web" ? "badge-primary" : 
                      framework.type === "app" ? "badge-secondary" : 
                      "badge-accent"
                    )}>
                      {framework.type}
                    </div>
