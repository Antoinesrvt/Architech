...
export default function LandingPage() {
  ...
  const benefitsTestimonials = [testimonials[0], testimonials[3], testimonials[4]];

  // Calculate scroll progress for the indicator
  const scrollProgress = typeof scrolled === 'number' ? Math.min(scrolled * 100, 100) : 0;

  return (
    <div className="min-h-screen bg-gray-950 text-white relative overflow-hidden">
      {/* Background decoration elements */}
      <div className="fixed inset-0 pointer-events-none z-0 opacity-30">
        <div className="absolute top-0 left-1/4 w-[800px] h-[800px] bg-purple-900/20 rounded-full blur-3xl parallax" data-speed="0.05" data-direction="up"></div>
        <div className="absolute top-1/4 right-1/3 w-[600px] h-[600px] bg-blue-900/20 rounded-full blur-3xl parallax" data-speed="0.07" data-direction="down"></div>
        <div className="absolute bottom-0 left-1/3 w-[900px] h-[900px] bg-indigo-900/20 rounded-full blur-3xl parallax" data-speed="0.03" data-direction="left"></div>
      </div>
      ...
      <div className="relative z-10">
        ...
        <div className={`py-16 bg-gray-950 relative transition-all duration-1000 ease-out ${isProblemVisible ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-10'}`}>
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            <div className="absolute -right-20 -bottom-40 w-[500px] h-[500px] bg-purple-800/5 rounded-full blur-3xl parallax" data-speed="0.08" data-direction="right"></div>
          </div>
        </div>
        ...
        <div className={`py-16 bg-gradient-to-r from-gray-950 to-gray-900 relative transition-all duration-1000 ease-out ${isBenefitsVisible ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-10'}`}>
          <div className="max-w-5xl mx-auto px-4 relative z-10">
            <Testimonials
              testimonials={benefitsTestimonials}
              variant="light"
            />
          </div>
          ...
          {/* Background parallax decoration */}
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            <div className="absolute -left-40 top-20 w-[600px] h-[600px] bg-blue-800/5 rounded-full blur-3xl parallax" data-speed="0.04" data-direction="up"></div>
          </div>
        </div>
        ...
        <div className={`py-16 bg-gradient-to-r from-gray-950 to-purple-950/20 relative transition-all duration-1000 ease-out ${isTechnicalVisible ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-10'}`}>
          <div className="max-w-5xl mx-auto px-4 relative z-10">
            <Testimonials
          ...
          {/* Background parallax decoration */}
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            <div className="absolute -right-20 bottom-0 w-[700px] h-[700px] bg-purple-800/5 rounded-full blur-3xl parallax" data-speed="0.05" data-direction="left"></div>
          </div>
        </div>
