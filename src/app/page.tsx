  ...
  const CardSkeleton = () => (
    <div className="card bg-base-100 shadow-lg animate-pulse">
      <div className="card-body">
        ...
        <div className="skeleton h-10 w-16 mt-2"></div>
            ...
            <>
              <div className={cn(
                ...
                <div className="card-body">
                  ...
                  <div className="card-actions justify-end">
                    <Link href="/frameworks" className="btn btn-sm btn-ghost transition-all hover:bg-base-200">View All</Link>
                  </div>
                </div>
              </div>
              ...
              <div className={cn(
                ...
                <div className="card-body">
                  ...
                  <div className="card-actions justify-end">
                    <Link href="/modules" className="btn btn-sm btn-ghost transition-all hover:bg-base-200">View All</Link>
                  </div>
                </div>
              </div>
