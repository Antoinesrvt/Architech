      ...
      <div className="space-y-8">
        ...
        <div className="card bg-base-100 shadow-lg">
          <div className="card-body">
            ...
            <div className="form-control w-full mb-4">
              ...
              />
              <label className="label">
                <span className="label-text-alt">Command used to open projects after generation</span>
              </label>
            </div>
        ...
        <div className="card bg-base-100 shadow-lg">
          <div className="card-body">
            ...
            <p className="py-2">
              ArchiTech is a powerful project generator for creating Next.js applications
