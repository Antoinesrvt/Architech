...
export const StepIndicator: React.FC<StepIndicatorProps> = ({
  ...
  return (
    <div className={containerClasses}>
      {/* Background line */}
      {showProgressLine && <div className={progressLineClasses} />}
      ...
      {steps.map((step, index) => {
        ...
        const indicatorClasses = cn(
          ...
          onStepClick &&
            ...
            "cursor-pointer hover:ring hover:ring-primary/30",
        );
        ...
        return (
          <div key={step.id} className={stepContainerClasses} style={stepStyle}>
            <div
              ...
              role={
                onStepClick && visitedSteps.has(index) ? "button" : undefined
              }
            ...
            {(showTitles || showDescriptions) && (
              ...
              >
                {showTitles && <div className={titleClasses}>{step.title}</div>}
