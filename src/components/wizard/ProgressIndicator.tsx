...
import type { GenerationProgress } from "@/lib/api/types";
...
export default function ProgressIndicator({
  ...
  const getFriendlyErrorMessage = (errorText: string) => {
    if (
      errorText.includes("tokio-runtime-worker") &&
      errorText.includes("Cannot start a runtime from within a runtime")
    ) {
