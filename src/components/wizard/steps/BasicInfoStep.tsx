...
export function BasicInfoStep({
  ...
  // Is the form valid?
  const isFormValid =
    !formErrors.name && !formErrors.path && projectName && projectPath;
    ...
    <div className="space-y-6 animate-fadeIn">
        ...
        <div className="card-body">
          ...
          <div className="form-control w-full">
            <label className="label">
              ...
              {isTouched.name && formErrors.name && (
                <span className="label-text-alt text-error animate-fadeIn">
                  {formErrors.name}
                </span>
              )}
            </label>
          ...
          <div className="form-control w-full mt-2">
            ...
            <label className="label">
              ...
              {projectDescription && (
                <span className="label-text-alt">
                  {projectDescription.length}/150 characters
                </span>
              )}
            </label>
          </div>
      ...
      <div
        className={cn(
          ...
          isFormValid
            ? "alert-success animate-pulse-slow border-success/30"
